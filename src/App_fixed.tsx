        ...
        return (
          <div className="space-y-6">
            <div className="eco-card rounded-xl p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Statistiques démographiques</h2>
              <p className="text-gray-600 mb-6">Corrélation entre niveau de déchets et densité de population, niveau de revenu, activité économique.</p>
              <div className="h-96 bg-gray-100 rounded-lg flex items-center justify-center">
                <p className="text-gray-500">Module de statistiques démographiques en développement</p>
              </div>
            </div>
          </div>
        )
